...
- Forwarding messages to Discord not working (#125)
...
- Uses a static file from the Member Audit app (#121)

## [3.2.1] - 2025-10-23

### Fixed

- Missing static file when showing fitting for Sotiyo (#118)
...
- Notification types for corporation projects / goals (#109).
...
- Ability to assign owners to webhooks on the webhooks admin page (#105). Big thanks to @weeeeems for the suggestion.
...
- Processing timer action on the admin site aborts with "set has no format" error
